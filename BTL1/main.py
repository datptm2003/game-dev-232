...
class Background:
    def __init__(self):
        self.img_background = pygame.image.load('./BTL1/images/backgroundInit1.png')

    def start(self):
        self.img_background = pygame.image.load('./BTL1/images/backgroundStartGame.png')

class Character:
    def __init__(self):
        self.img_character_1 = pygame.image.load('./BTL1/images/mole_11.png')
        self.img_character_2 = pygame.image.load('./BTL1/images/mole_12.png')
        self.img_character_3 = pygame.image.load('./BTL1/images/mole_1.png')
        self.img_character_4 = pygame.image.load('./BTL1/images/mole_2.png')
        self.img_character_5 = pygame.image.load('./BTL1/images/mole_21.png')
        self.img_character_6 = pygame.image.load('./BTL1/images/mole_22.png')
        self.data = []
...
class GameContainer:
    def __init__(self):
        ...
        # Change mouse
        self.mouseImage = pygame.image.load("./BTL1/images/mouse1.png")
        self.mouseImage_rect = self.mouseImage.get_rect()
        
        # Add effectively when hitting
        self.lazeImage = pygame.image.load("./BTL1/images/laze1.png")
    ...
    def updateZombie(self):
        self.screen.blit(pygame.image.load('./BTL1/images/holes.png'), (0, 300))
    ...
    def update(self):
        self.screen.blit(pygame.image.load('./BTL1/images/timeContainer.png'), (1080, 0))
        # Update time
                ...
                if play_box.collidepoint(pygame.mouse.get_pos()):
                    if hover == 0:
                        ...
                        self.bg.img_background = pygame.image.load(
                            './BTL1/images/backgroundInit2.png')
                        self.screen.blit(self.bg.img_background, (0, 0))
                        hover = 1
                else:
                    if hover == 1:
                        ...
                        self.bg.img_background = pygame.image.load(
                            './BTL1/images/backgroundInit1.png')
                        self.screen.blit(self.bg.img_background, (0, 0))
                        hover = 0
